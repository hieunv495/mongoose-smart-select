...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$startRuleFunctions = { fields_select: peg$parsefields_select },
        peg$startRuleFunction  = peg$parsefields_select,
        ...
        peg$c23 = function(fields_select) { return fields_select},
        peg$c24 = function() { return { all: true,fields: []}},
        peg$c25 = function(name) { return {type: "remove", name:name}},
        peg$c26 = function(name, fields_select, range) { return {name:name,select: fields_select, range:range } },
        peg$c27 = function(name, range, fields_select) { return {name:name, select: fields_select, range:range} },
        peg$c28 = function(name, fields_select) { return {name:name, select: fields_select} },
        peg$c29 = function(name, range) { return {name: name, range: range}},
        peg$c30 = function(name) {return {name: name}},
        peg$c31 = function() {return {spread: true}},
        peg$c32 = /^[_a-zA-Z0-9]/,
        peg$c33 = peg$classExpectation(["_", ["a", "z"], ["A", "Z"], ["0", "9"]], false, false),
        peg$c34 = function() {return text()},
        peg$c35 = function(from, to) {return {from: from, to: to}},
        peg$c36 = function(from) { return {from: from, to: null}},
        peg$c37 = function(to) { return {from: null, to: to}},
        peg$c38 = function() { return {from:null, to: null}},
        peg$c39 = function(limit, page) { return {limit:limit,page:page} },
        peg$c40 = function(limit) { return {limit:limit,page:1} },
        peg$c41 = function(page) { return {page:page} },
        peg$c42 = function() { return {page:1} },
    ...
    function peg$parsefields_select() {
    ...
    function peg$parsefields_wrapper() {
      var s0, s1, s2, s3;
